...
//https://console.cloud.google.com/projectselector2/apis/credentials?supportedpurview=project&pli=1
...
public class GoogleDriveStorageService : IStorageService
{
    ...
    public string Upload(IFormFile file, User user)
    {
        ...
        //parents.Add("1plNHo6ndWsHNHGqDTLjmnXIpLp7-ntet?usp=drive_link");
